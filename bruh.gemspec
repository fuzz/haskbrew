...
require_relative 'lib/bruh/version'

Gem::Specification.new do |spec|
  spec.name = 'bruh'
  spec.version = Bruh::VERSION
  ...
  spec.homepage = 'https://github.com/fuzz/bruh'
  spec.license = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/fuzz/bruh'
  spec.metadata['changelog_uri'] = 'https://github.com/fuzz/bruh/blob/main/CHANGELOG.md'
